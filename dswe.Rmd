...
#ggsave(age_plot, "age_plot.jpg", width = 4, height = 6)
...
Young people seems to be less interested in the car insurance. The median age for interested customers is 43 years (IQR: 35, 51), while the median for non-interested customers is 34 years (IQR: 24, 49)

## H2) Women are likely to be interested the car insurance.❌
...
#ggsave(gender_plot, "gender_plot.png")
```
...
For customers interested in the car insurance, 61% were men, and 33% were women. So, this hypothesis is FALSE. Although, gender and response are statistically significant, i.e., are related.
...
df_cleaned %>% 
  ...
  labs(title = "vehicle_age vs. Response", 
       x = 'Response', y = "Number of customers")
  theme_bw()
...
H5) O interesse é maior para quem teve o carro previamente assegurado.
